...
const Contact = () => {
    return (
        <div name="contanct" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
                <div className='pb-8'>
                  ...
                  <div className='flex justify-center items-center '>
                    <form action="https://getform.io/f/fdf6a3d4-7041-419d-b8ce-0f0cd37f4614"
                   ...
                   <input type="text" name="email" placeholder='Enter Your email' id="" className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
